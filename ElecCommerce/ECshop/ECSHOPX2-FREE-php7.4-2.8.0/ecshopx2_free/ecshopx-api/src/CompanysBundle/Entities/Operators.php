...
class Operators
{
    ...
    */
     ...
     * @var string
     *
     * @ORM\Column(name="lastloginip", type="string", nullable=true, options={"comment":"添加时候的ip"})
     *
     */
    private $lastloginip;
     ...
     * @var string
     *
     * @ORM\Column(name="head_portrait", type="text",  nullable=true, options={"comment":"头像"})
     */
     ...
     * @var integer
     *
     * @ORM\Column(name="is_disable", type="integer", nullable=true, options={"comment":"是否禁用 1:是 0:否", "default": 0})
     */
     ...
     * @var string
     *
     * @ORM\Column(name="is_dealer_main", type="string", options={"comment":"是否是经销商主账号  1：是   0：不是", "default": 1})
     */
     ...
     * @var string
     *
     * @ORM\Column(name="is_merchant_main", type="string", options={"comment":"是否是商户端超级管理员  1：是   0：不是", "default": 0})
     */
