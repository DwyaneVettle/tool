...
class NormalOrdersItems
{
     ...
     * @var int
     *
     * @ORM\Column(name="discount_fee", type="integer", options={"unsigned":true, "comment":"订单优惠金额，以分为单位", "default":0})
     */
    ...
    */
     ...
     * @var integer
     *
     * @ORM\Column(name="ome_order_id", type="bigint", length=64, nullable=true, options={"comment":"ome订单号"})
     */
