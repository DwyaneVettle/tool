...
/**
 * WechatAuth 微信授权表(订阅号，公众号，小程序)
 *
 * @ORM\Table(name="wechat_authorization", options={"comment":"微信授权表(订阅号,公众号,小程序)"})
...
class WechatAuth
{
     ...
     *
     * @ORM\Id
     * @ORM\Column(name="authorizer_appid", type="string", length=64, options={"comment":"小程序appid"})
     */
     ...
     * @var string
     *
     * @ORM\Column(name="authorizer_appsecret", nullable=true, type="string", options={"comment":"小程序appsecret"})
     */
     ...
     * @var string
     *
     * @ORM\Column(name="authorizer_refresh_token", nullable=true, type="string", options={"comment":"小程序refresh_token"})
     */
     ...
     * @var string
     *
     * @ORM\Column(name="nick_name", type="string", length=50, options={"comment":"昵称"})
     */
    private $nick_name;
     ...
     * @var string
     *
     * @ORM\Column(name="head_img", type="string", nullable=true, options={"comment":"小程序Logo"})
     */
    private $head_img;
     ...
     * @var integer
     *
     * @ORM\Column(name="service_type_info", type="integer", nullable=true, options={"comment":"授权方公众号类型。可选值有 0代表订阅号；1代表由历史老帐号升级后的订阅号；2代表服务号；3代表小程序(自定义)"})
     */
     ...
     * @var integer
     *
     * @ORM\Column(name="verify_type_info", type="integer", nullable=true, options={"comment":"授权方认证类型，-1代表未认证;0代表微信认证;1代表新浪微博认证;2代表腾讯微博认证;3代表已资质认证通过但还未通过名称认证;4代表已资质认证通过、还未通过名称认证，但通过了新浪微博认证;5代表已资质认证通过、还未通过名称认证，但通过了腾讯微博认证"})
     */
     ...
     * @var integer
     *
     * @ORM\Column(name="user_name", type="string", length=32, nullable=true, options={"comment":"原始 ID"})
     */
    private $user_name;
     ...
     * @var string
     *
     * @ORM\Column(name="signature", nullable=true, type="text", options={"comment":"账号介绍"})
     */
    private $signature;
     ...
     * @var string
     *
     * @ORM\Column(name="principal_name", type="string", nullable=true, options={"comment":"公众号的主体名称"})
     */
     ...
     * @var string
     *
     * @ORM\Column(name="alias", type="string", nullable=true, length=50, options={"comment":"授权方公众号所设置的微信号，可能为空"})
     */
    private $alias;
     ...
     * @var string
     *
     * @ORM\Column(name="business_info", nullable=true, type="json_array", options={"comment":"用以了解以下功能的开通状况（0代表未开通，1代表已开通）。open_store:是否开通微信门店功能;open_scan:是否开通微信扫商品功能;open_pay:是否开通微信支付功能;open_card:是否开通微信卡券功能;open_shake:是否开通微信摇一摇功能"})
     */
     ...
     * @var string
     *
     * @ORM\Column(name="qrcode_url", type="string", nullable=true, options={"comment":"二维码图片的URL"})
     */
    private $qrcode_url;
     ...
     * @var string
     *
     * @ORM\Column(name="miniprograminfo", type="json_array", nullable=true, options={"comment":"可根据这个字段判断是否为小程序类型授权"})
     */
     ...
     * @var string
     *
     * @ORM\Column(name="func_info", type="string", nullable=true, options={"comment":"公众号授权给开发者的权限集列表,逗号隔开"})
     */
    private $func_info;
     ...
     * @var integer
     *
     * @ORM\Column(name="auto_publish", type="smallint", length=1, options={"default":0,"comment":"自动发布,第三方授权模式才有用，直连用不到此配置。1:自动发布,0:不自动发布"})
     */
