...
$api->version('v1', function($api) {
    ...
    $api->group(['namespace' => 'OrdersBundle\Http\Api\V1\Action', 'middleware' => ['api.auth','shoplog'], 'providers' => 'jwt'], function($api) {
        ...
        $api->get('/invoice/number', ['name'=>'设置订单发票号', 'middleware'=>'activated',  'as' => 'order.invoicenumber.set',  'uses'=>'Order@updateInvoiceNumber']);
        $api->get('/invoice/invoiced', ['name'=>'设置订单开票状态', 'middleware'=>'activated',  'as' => 'order.invoiced.invoiced',  'uses'=>'Order@setInvoiced']);
