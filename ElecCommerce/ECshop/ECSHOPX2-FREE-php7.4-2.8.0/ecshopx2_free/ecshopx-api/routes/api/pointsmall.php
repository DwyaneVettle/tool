...
$api->version('v1', function($api) {
    ...
    $api->group(['namespace' => 'PointsmallBundle\Http\Api\V1\Action', 'middleware' => ['api.auth', 'activated', 'shoplog'], 'providers' => 'jwt', 'prefix' => 'pointsmall'], function($api) {
        ...
        $api->post('/goods/attributes', ['name' => '新增商品属性', 'as' => 'pointsmall.goods.attributes.add', 'uses' => 'ItemsAttributes@addItemsAttributes']);
        $api->put('/goods/attributes/{attribute_id}', ['name' => '更新商品属性', 'as' => 'pointsmall.goods.attributes.update', 'uses' => 'ItemsAttributes@updateItemsAttributes']);
        $api->get('/goods/attributes', ['name' => '获取商品属性列表', 'as' => 'pointsmall.goods.attributes.list', 'uses' => 'ItemsAttributes@getItemsAttrList']);
        $api->delete('/goods/attributes/{attribute_id}', ['name' => '删除商品属性', 'as' => 'pointsmall.goods.attributes.delete', 'uses' => 'ItemsAttributes@deleteItemsAttributes']);
